...
public class P4_MusicRadio {
	public static class MapperClass extends Mapper<LongWritable, Text, Text, IntWritable> {
		public void map(LongWritable key, Text value, Context con) throws IOException, InterruptedException {
			...
			for(String word:parts){
				...
				IntWritable outputvalue = new IntWritable(Integer.parseInt(val[3]));
	...
	public static class ReducerClass extends Reducer<Text,IntWritable,Text,IntWritable> {
		protected void setup(Context con) throws IOException, InterruptedException {
			con.write(new Text("The Number of Times Track is Listened on Radio"), null);
	    }
		int cnt=0;
	...
	public static void main(String[] args) throws Exception{
		...
		Job j = Job.getInstance(conf, "P4_MusicRadio");
		j.setJarByClass(P4_MusicRadio.class);
